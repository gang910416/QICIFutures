...
- (void)drawRect:(CGRect)rect {
    ...
    [NSObject gl_drawTextBackGroundInRect:rect content:ctx boderColor:QICIColorSeparator boderWidth:1.0f fillColor:[QICIColorNormalText colorWithAlphaComponent:0.6]];
