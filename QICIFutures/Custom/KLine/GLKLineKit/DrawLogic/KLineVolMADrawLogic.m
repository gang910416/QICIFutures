...
//ASDFUNC
//- (void)p_initialization_asd {
//
//    [self p_asdFuncAllHIHKJ];
//
//    self.lineWidth = 1.0f;
//
...
- (void)p_drawIndicatorDetailWithRect:(CGRect)rect {
    ...
    if (self.selectedModel) {
        ...
        NSMutableAttributedString *mattirbuteStr = [[NSMutableAttributedString alloc] initWithString:indicatorName attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10.0f],NSForegroundColorAttributeName:QICIColorTipText}];
