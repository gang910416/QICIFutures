 ...
 */
- (void)beginTapKLineView:(ASDKLineView *)view touchPoint:(CGPoint)point perItemWidth:(CGFloat)perItemWidth;
...
/**
 ...
 @param perItemWidth 当前的item宽度
 */
- (void)moveTouchAtKLineView:(ASDKLineView *)view touchPoint:(CGPoint)point perItemWidth:(CGFloat)perItemWidth;
...
/**
 ...
 @param perItemWidth 当前的Item宽度
 */
- (void)removeTouchAtKLineView:(ASDKLineView *)view touchPoint:(CGPoint)point perItemWidth:(CGFloat)perItemWidth;
#pragma mark - 禁用方法 --
